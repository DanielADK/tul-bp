...
Navrhování systému s ohleden na budoucí potřeby a možnosti rozšíření je přístup, který zajišťuje, že investice vývoje přispeje k dlouhodobé udržitelnosti a přinese novou, trvalou hodnotu.
